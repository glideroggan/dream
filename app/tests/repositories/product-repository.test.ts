...
import { ProductEntityType } from '../../src/repositories/models/product-models';
import { setupDateAndRandomMocks, cleanupDateAndRandomMocks } from '../utils/test-helpers';

// TODO: these tests are testing the wrong service now, ProductRepository is now a template for products
...
//         productRepo = ProductRepository.createTestInstance(mockStorage as StorageService);
