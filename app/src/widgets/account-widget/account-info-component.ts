  ...
  <div class="account-info">
    <div class="info-section">
      ...
      <div class="account-balance">
        ...
        <span class="balance-amount ${x => (x.account?.balance || 0) < 0 ? 'negative' : ''}">
    ...
    <div class="info-section details-section">
      ...
      <div class="detail-row">
        ...
        <span class="detail-value">${x => x.formatAccountNumber(x.account?.accountNumber || '')}</span>
      </div>
      <div class="detail-row">
        <span class="detail-label">Created</span>
        <span class="detail-value">${x => x.formatDate(x.account?.createdAt || '')}</span>
      </div>
      <div class="detail-row">
        <span class="detail-label">Status</span>
        <span class="detail-value status ${x => x.account?.isActive ? 'active' : 'inactive'}">
          ${x => x.account?.isActive ? 'Active' : 'Inactive'}
        </span>
      </div>
      <div class="detail-row">
        <span class="detail-label">Interest Rate</span>
        <span class="detail-value">${x => x.account?.interestRate ? x.account.interestRate + '%' : 'N/A'}</span>
      </div>
    </div>
...
export class AccountInfoComponent extends FASTElement {
