...
const workflowDefinitions: WorkflowDefinition[] = [
  ...
  },
  {
    id: WorkflowIds.ADD_CONTACT,
      name: "Manage Payment Contacts",
      description: "Add, edit, or delete payment contacts for transfers",
      elementName: "add-contact-workflow",
      module: "@workflows/add-contact-workflow",
      icon: "👤",
      searchable: true,
      keywords: ['contact', 'add contact', 'payment contact', 'recipient', 'payee', 'edit contact', 'delete contact', 'manage contacts', 'change contact', 'update contact', 'remove contact'],
  },
  {
